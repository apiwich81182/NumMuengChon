                    ...
                    <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-100">
                      {aj.customerPhone ? (
                        <a
                          ...
                          className="py-2.5 px-2 rounded-xl bg-slate-50 hover:bg-slate-100 active:scale-[0.98] text-slate-800 font-semibold text-xs flex items-center justify-center gap-1.5 transition border border-slate-200"
                        >
                        ...
                        <button
                          disabled
                          className="py-2.5 px-2 rounded-xl bg-slate-50 text-slate-400 text-xs flex items-center justify-center gap-1.5 cursor-not-allowed border border-slate-100"
                        >
                      ...
                      {navUrl ? (
                        <a
                          ...
                          className="py-2.5 px-2 rounded-xl bg-blue-50 hover:bg-blue-100 active:scale-[0.98] text-blue-700 font-semibold text-xs flex items-center justify-center gap-1.5 transition border border-blue-200/80"
                        >
        ...
        <div className="space-y-3">
          {jobs.length === 0 ? (
            <div className="bg-white rounded-2xl border border-dashed border-slate-300 p-8 sm:p-12 text-center space-y-3">
              <div className="w-12 h-12 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mx-auto text-2xl shadow-2xs">
                📋
              </div>
              <div className="space-y-1">
                <h3 className="font-bold text-slate-800 text-base">
                  ยังไม่มีประวัติงานสูบส้วมในเงื่อนไขนี้
                </h3>
                <p className="text-xs text-slate-500 max-w-sm mx-auto">
                  คุณสามารถปรับเปลี่ยนตัวกรองช่วงเวลา หรือเริ่มบันทึกส่งงานหน้างานใหม่ได้ทันที
                </p>
              </div>
              <div className="pt-2 flex items-center justify-center gap-3">
                ...
                <Link
                  href="/jobs/new"
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 active:scale-[0.98] text-white text-xs font-semibold rounded-xl transition shadow-xs flex items-center gap-1.5"
                >
